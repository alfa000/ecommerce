                ...
                <div class="position-breadcrumb">
                    <nav aria-label="breadcrumb" class="d-inline-block">
                        <ul class="breadcrumb rounded shadow mb-0 px-4 py-2">
                            <li class="breadcrumb-item"><a href="index-shop.html">Home</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="tiny-single-item">
                            <div class="tiny-slide"><img src="{{ asset('storage/'.$item->img) }}" class="img-fluid rounded" alt=""></div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-7 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-md-4">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="list-unstyled mb-0 ms-3">
                                            <li class="list-inline-item"><a href="javascript:void(0)" class="btn btn-soft-primary">{{ $item->category }}</a></li>
                                        </ul>
                                    </div>
                                </div><!--end col-->
                            ...
                            <div class="mt-4 pt-2">
                                <a href="shop-cart.html" class="btn btn-primary">Add to Cart</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
